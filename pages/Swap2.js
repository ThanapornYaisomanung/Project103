...
export default function Swap2({ navigation }) {
  return (
    <View>
      {/* หัว */}
      ...
      <View>
        ...
        <View style={{ flexDirection:"row"}}>
        <View >
        <Image source={{uri: 'https://image.sistacafe.com/images/uploads/summary/image/9788/1463919386-1386559081-19ac069f16-o.jpg'}} 
        style={{
            height:200,
            width:150,
            borderRadius:15,
       ...
       <Ionicons 
        ...
        <Text style={{
            ...
            fontWeight:"bold",
            fontSize:25,
        }}onPress={() => navigation.navigate("Swap1")}>CENCLE!!</Text>
    </TouchableOpacity>
        ...
        marginRight:50,
        marginTop:20,}}  
        onPress={() => navigation.navigate("Swap3")}>
        <Text style={{
            color:"#fff",
            fontWeight:"bold",
            fontSize:25,
